...
let noticeEl = document.getElementById('notice-container')
let counterEl = document.getElementById('counter')
const notice = document.getElementById('upgrade-notice')
let apiEL = document.getElementById('api-link')
setTimeout(()=>{
...
let secondsRemaining2 =300
let countdownInterval2 = setInterval(function () {
  if (secondsRemaining2 > 0) {
    secondsRemaining2--

    counterEl.innerText=secondsRemaining2

    console.log(secondsRemaining2)
  } else {
